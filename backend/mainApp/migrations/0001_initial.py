# Generated by Django 4.1.7 on 2023-10-22 07:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isAvailable', models.BooleanField(default=True)),
                ('package_name', models.CharField(blank=True, default='no package', max_length=100, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Package',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nearat', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paymentMethod', models.CharField(max_length=50)),
                ('nonCashReference', models.CharField(blank=True, max_length=128, null=True)),
                ('agentPayment', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10, null=True)),
                ('totalAmountToPay', models.DecimalField(decimal_places=2, max_digits=10)),
                ('cashAmountPay', models.DecimalField(decimal_places=2, max_digits=10)),
                ('balance', models.DecimalField(decimal_places=2, max_digits=10)),
                ('discountMode', models.CharField(blank=True, max_length=50)),
