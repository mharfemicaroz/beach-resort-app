...
urlpatterns = [
    ...
    re_path(r'^restoitem/category/$', itemcategory_list,
            name='itemcategory-list'),
    re_path(r'^restoitem/category/(?P<pk>\d+)/$',
            itemcategory_list, name='itemcategory-detail'),
    re_path(r'^restoitem/category/filter/$', itemcategory_filter,
            name='itemcategory-filter'),
