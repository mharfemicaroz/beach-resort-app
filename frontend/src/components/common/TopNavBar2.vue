        ...
        <div class="container-fluid" style="padding-left: 25px; padding-right: 25px;">
            ...
            <a class="navbar-brand text-white align-middlev vv  vv  v  vv v " href="#">
                <div style="display: flex; align-items: center;">
                    <img src="@/assets/hardware.png" width="45" height="45" class="d-inline-block align-top"
                        alt="Pantukan Waterworld Logo" style="margin-right: 10px;">
                    <span style="flex: 1;">Dumaluan Hardware</span>
                </div>
            </a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            <div v-if="userdata.role === 'superuser'">
                                <li><router-link to="/hardware" tag="a" class="dropdown-item">Main</router-link></li>
...
export default {
    data() {
        return {
            backgroundIndex: 0,
            backgrounds: [
                "src/assets/header2bg1.png",
                "src/assets/header2bg2.png",
            ],
            user: {
                username: "",
                password: "",
    ...
    mounted() {
        //this.enterFullscreen();
        document.title = "Dumaluan Hardware Portal"
    }
}
</script>
