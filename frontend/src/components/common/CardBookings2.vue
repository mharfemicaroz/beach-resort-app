        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            ...
            >
              ...
              <span
                v-if="cancelledRoomData.length > 0"
                class="badge-pill badge-danger"
                >{{ cancelledRoomData.length }}</span
              >
            </button>
          </h2>
          <div
            ...
            <div class="accordion-body">
              <div class="col-md-12">
                <div class="row row-cols-1 row-cols-md-4">
                  <div
                    class="col mb-4"
                    v-for="(item, index) in cancelledRoomData"
                    :key="item.id"
                  >
                    <div
                      class="card"
        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button
              ...
              type="button"
              data-bs-toggle="collapse"
              data-bs-target="#collapsehold"
              aria-expanded="true"
              aria-controls="collapsehold"
            >
              Temporary Reservations
              <span
                v-if="holdRoomData.length > 0"
                class="badge-pill badge-danger"
                >{{ holdRoomData.length }}</span
              >
            </button>
          </h2>
          <div
            ...
            <div class="accordion-body">
              <div class="col-md-12">
                <div class="row row-cols-1 row-cols-md-4">
                  <div
                    class="col mb-4"
                    v-for="(item, index) in holdRoomData"
                    :key="item.id"
                  >
                    <div
                      class="card"
  ...
  computed: {
    ...
    holdRoomData() {
      return this.roomData
        .filter(
          (o) =>
            o.status === "reserved" && (o.isPaid === "" || o.isPaid === "no")
        )
        .map((o) => {
          let checkoutDate = new Date(parseDate(o.checkoutDate));
          checkoutDate.setDate(checkoutDate.getDate() + 1);
    ...
    arrivingRoomData() {
      return this.roomData
        .filter(
          (o) => o.status === "reserved" && o.isPaid !== "" && o.isPaid !== "no"
        )
        .map((o) => {
          let checkoutDate = new Date(parseDate(o.checkoutDate));
          checkoutDate.setDate(checkoutDate.getDate() + 1);
    ...
    vacantRoomData() {
      // Use filter to remove items that exist in this.departRoomData
      return this.roomData.filter(
        (o) =>
          !("itemID" in o) &&
          !this.departRoomData.some((d) => d.name === o.name)
      );
    },
  },
};
