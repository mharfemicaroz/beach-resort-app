              ...
              >
                <li class="nav-item">
                  <a
                    class="nav-link active"
                    data-bs-toggle="tab"
                    @click="activeMainTab = 'BEACH ROOM'"
                    href="#beachroom"
                    >Beach Rooms</a
                  >
                </li>
                ...
                <li class="nav-item">
                  <a
                    class="nav-link"
                    data-bs-toggle="tab"
                    @click="activeMainTab = 'POOL COTTAGE'"
                    href="#poolcottages"
                    >Pool Cottages</a
                  >
                </li>
                <li class="nav-item">
                  <a
                    class="nav-link"
                    data-bs-toggle="tab"
                    @click="activeMainTab = 'GAZEBO COTTAGE'"
                    href="#gazebocottages"
                    >Native Gazebo Cottages</a
                  >
                </li>
                <li class="nav-item">
                  <a
                    class="nav-link"
                    data-bs-toggle="tab"
                    @click="activeMainTab = 'BEACH COTTAGE'"
                    href="#beachcottages"
                    >Beach Cottages (Day)</a
                  >
                </li>
                <li class="nav-item">
                  <a
                    class="nav-link"
                    data-bs-toggle="tab"
                    @click="activeMainTab = 'N-BEACH COTTAGE'"
                    href="#nbeachcottages"
                    >Beach Cottages (Night)</a
                  >
                </li>
                <li class="nav-item">
                  <a
            ...
            <div class="col-sm-10">
              <div class="tab-content mt-3" id="propertyTabContent">
                ...
                <div
                  ...
                  id="poolcottages"
                  role="tabpanel"
                  aria-labelledby="poolcottage-tab"
                >
                  <div class="container-fluid">
                    <div class="row">
                      <div class="col-md-12">
                ...
                <div
                  ...
                  id="gazebocottages"
                  role="tabpanel"
                  aria-labelledby="gazebocottage-tab"
                >
                  <div class="container-fluid">
                    <div class="row">
                      <div class="col-md-12">
                ...
                <div
                  ...
                  id="beachcottages"
                  role="tabpanel"
                  aria-labelledby="beachcottage-tab"
                >
                ...
                <div
                  ...
                  id="nbeachcottages"
                  role="tabpanel"
                  aria-labelledby="nbeachcottage-tab"
                >
                  <div class="container-fluid">
                    <div class="row">
                      <div class="col-md-12">
